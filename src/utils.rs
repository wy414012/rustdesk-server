...
fn doctor_ip(server_ip_address: std::net::IpAddr, server_address: Option<&str>) {
    ...
    doctor_tcp(server_ip_address, "41114", "API");
    doctor_tcp(server_ip_address, "41115", "hbbs extra port for nat test");
    doctor_tcp(server_ip_address, "41116", "hbbs");
    doctor_tcp(server_ip_address, "41117", "hbbr tcp");
    doctor_tcp(server_ip_address, "41118", "hbbs websocket");
    doctor_tcp(server_ip_address, "41119", "hbbr websocket");
